...
public class GreencityTest {
    ...
    public void checkLogin(String email, String password) {
        ...
        GreenAllEvents greencityAllEvents;
    ...
    public void checkEvents(String page) {
        ...
        try (Response response = client.newCall(request).execute()) {
            resultJson = response.body().string();
            greenAllEvents = gson.fromJson(resultJson, GreenAllEvents.class);
            isSuccess = response.isSuccessful();
        } catch (IOException e) {
            System.out.println("IOException e = " + e);
            throw new RuntimeException(e);
        ...
        Assertions.assertTrue(isSuccess);
        System.out.println("resultJson: " + resultJson);
        System.out.println("greencityAllEvents: " + greenAllEvents);
    }
}